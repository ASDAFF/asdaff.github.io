...
debug = !!debug, function () {
    ...
    Visibility.onVisible(function () {
        intro && setTimeout(function () {
            $(window).resize();
            var $main = $("#main");
            $main.toggleClass("play"), $main.find("#skills-slider").yslider(["WEB", "BITRIX", "JS"], {
                speed: 300,
                pause: 2e3,
                delay: 2e3
    ...
    setTimeout(function () {
        ...
        var n = "asdaff.asad".substr(2) + "@yandex.ru";
        $(".email").attr("href", "mailto:" + n).attr("title", n)
    }, 1e3), $(".navigation a").each(function (i, e) {
        var a = $(e), element = a.attr("href");
        new Waypoint({
            element: element, handler: function (dir) {
                console.log("1 " + element + " " + dir), a.parent().parent().children().removeClass("active"), "up" == dir ? a.parent().prev().addClass("active") : a.parent().addClass("active")
            }, offset: 50
        })
